            ...
            <div className="container mx-auto px-4 py-10">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        ...
                        <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl"></div>
                        <div className="absolute -top-6 -left-6 w-32 h-32 bg-emerald-500/30 rounded-full blur-3xl"></div>
