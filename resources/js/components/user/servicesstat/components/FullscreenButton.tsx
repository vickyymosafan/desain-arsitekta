...
// Position lookup for cleaner rendering
...
const FullscreenButton: React.FC<FullscreenButtonProps> = ({ 
  ...
  // Class names for button based on label presence
  const buttonClasses = `
    flex items-center gap-2 
    bg-neutral-900/80 backdrop-blur-md p-2 
    ${label ? 'pl-3 pr-4 rounded-full' : 'rounded-full'} 
  ...
  return (
    <motion.div className={`absolute ${POSITION_CLASSES[position]} z-50 flex items-center`}>
      <motion.button
        onClick={onClick}
